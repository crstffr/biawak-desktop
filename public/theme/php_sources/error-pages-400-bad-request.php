            ...
            <div class="error-block-wrapper">
                <div class="error-block">
                    <div class="error-left">
                        <h1 data-text="400">400</h1>
                        <span class="error-message">Sorry, there's been an error.</span>
                        <span class="error-details">
                            Bad request.<a href="#" class="bootstrap-tooltip" data-placement="top" data-original-title="The request cannot be fulfilled due to bad syntax."><i class="icon-photon info-circle"></i></a>
                        </span>
                    </div>
