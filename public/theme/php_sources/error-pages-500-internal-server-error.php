            ...
            <div class="error-block-wrapper">
                <div class="error-block">
                    <div class="error-left">
                        <h1 data-text="500">500</h1>
                        <span class="error-message">Sorry, there's been an error.</span>
                        <span class="error-details">
                            Internal Server Error.<a href="#" class="bootstrap-tooltip" data-placement="top" data-original-title="A generic error message, given when no more specific message is suitable."><i class="icon-photon info-circle"></i></a>
                        </span>
                    </div>
